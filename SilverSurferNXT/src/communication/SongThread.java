...
/*
    private int[] pinkFrequencies = { SI_KRUIS, HOGE_DO_KRUIS, RUST,
            ...
            HOGE_MI, HOGE_SOL_KRUIS, RUST, HOGE_HOGE_DO, HOGE_HOGE_DO_BMOL,
    ...
    private int[] pinkDurations = { sixteenth, quarter, dottedEighth,
            ...
            sixteenth, sixteenth, eighth, sixteenth, sixteenth, half, twelfth,
            twelfth, twelfth, twelfth, twelfth, twelfth, whole, half, quarter,
            ...
            eighth, half, twelfth, twelfth, twelfth, eighth, eighth, half,
            whole };

    @Override
    public void run() {
        for (int i = 0; i < pinkFrequencies.length; i++) {
            Sound.playTone(pinkFrequencies[i], pinkDurations[i]);
            try {
