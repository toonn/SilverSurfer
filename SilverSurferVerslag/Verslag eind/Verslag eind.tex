...
%TODO uitleggen hoe infraroodsensor werkt!! Is dit niet al in orde?
...
Op figuur \ref{rowi} is te zien hoe de robot de wip kan openen met de lange schep.

\begin{figure}[h]
\caption{Robot die de wip openent}
\centering
\includegraphics[scale=0.1]{robotWip.jpg}
\label{robowip}
\end{figure}
