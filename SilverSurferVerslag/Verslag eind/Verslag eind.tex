...
Indien de robot het unieke paar ook in zijn map heeft, kunnen beide mappen worden samengevoegd. E\'en van beide overeenkomende punten van de paren wordt als referentiepunt gekozen. Beide mappen worden getransleerd tot hun respectievelijk referentiepunt in de oorsprong ligt. De robot vergelijkt dan de co\"ordinaten van het andere punt uit het unieke paar. Wanneer deze in de twee mappen niet gelijk zijn, wordt de tweede map geroteerd tot deze wel gelijk zijn. Ten slotte wordt de tweede map nog getransleerd zodat haar oorsprong overeenkomt met de oorspronkelijke (niet getransleerde) oorsprong van de eerste map. Deze laatste translatie is simpelweg de inverse van de translatie van de eerste map naar de oorsprong.\\
De transformatiematrices van de translatie van de tweede map naar de oorsprong, de rotatie van de tweede map en de translatie van de tweede map naar de oorspronkelijke oorsprong van de eerste map worden vermenigvuldigd tot een algemene transformatiematrix waarmee alle co\"ordinaten berekend kunnen worden. Deze verandert echter alleen de co\"ordinaten van de tegels. De tegels moeten ook afzonderlijk de juiste ori\"entatie krijgen. Deze wordt verkregen uit de unieke paren. Stel dat Dead-end.N overeen komt met Dead-end.S, dan komt N dus overeen met S en bijgevolg E met W, S met N en W met E.\\
...
\begin{center}
	...
	week 11 & 10u30 & 13u20 & 7u10 & 12u10 & 7u50 & 22u00\\ \hline
	totaal & 122u15 & 131u55 & 112u00 & 112u47 & 117u50 & 205u15 \\
	gemiddeld & 11u06 & 11u59 & 10u12 & 10u15 & 10u43 & 18u40
    \end{tabular}
...
De scheidsrechterscommissie heeft ervoor gekozen, het \textit{HTTTP}-protocol door \'e\'en team te laten maken. Dit was handig voor de andere teams: zo konden zij hun tijd anders besteden. Het zorgde er echter ook voor dat voor de andere teams veel onduidelijkheid ontstond rond het protocol, enkel het `protocol-team' begreep volledig hoe het gebruikt moest worden. Bovendien werden soms vlak voor een demo wijzigingen doorgevoerd. Wanneer het protocol door meerdere teams geschreven zou zijn, zouden deze problemen misschien verholpen zijn geweest.
...
%Er is veel tijd verloren aan het verstaan en begrijpen van het protocol. De wiki van het protocol werd niet upgedate. Dit was zeer vervelend. Pas nadat er veel fouten waren doorgegeven aan het team van het protocol werd de wiki geupdaten en wisten we dat de fout aan iets anders lag dan dat we dachten. De documentatie van het protocol was ook helemaal niet duidelijk. Bij de ... stond er dat dit alleen maar voor assisten en visitors bedoeld was. Uiteindelijk bleek het dat dit ook moest ge"implementeerd worden. Dit bleek net hetzelfde met het `locken' van een wip. 
...
\section*{Tekst Scheidsrechter commissie}
%stuk over de scheidsrechtercommissie in het eindverslag, door elk lid van de spelcommissie, met o.a.: evaluatie van de spelcommissie en eigen inbreng\\

De vergaderingen van de scheidsrechter commissie waren er voor samen beslissingen te nemen over de invulling van het project. We zaten met 11 teams samen en afwisselend werd er iemand voorzitter en secretaris. Het probleem was alleen dat sommige voorzitters niet goed wisten hoe ze een vergadering moesten leiden waardoor discussi"eren soms moeilijk werd. \\

De vergaderingen waren niet altijd even effici"ent. Sommige discussies waren heel frustrerend omdat er mensen waren die ongefundeerde reacties gaven of omdat er over iets gediscussieerd werd dat helemaal geen zin had. Het feit dat het HTTTP protocol helemaal geschreven was door een team was wel handig langst de ene kant omdat ons team daar dan niet veel werk in moest steken, langst de andere kant was het soms vaag wat er allemaal gebeurde met het HTTTP protocol. Het zou beter zijn geweest moesten er meerdere teams daar samen aan gewerkt hebben. Ook helemaal op het einde voerde dit team nog aanpassingen door aan het protocol.  \\

 Het voordeel van de scheidsrechter commissie was dat er maar een persoon zich moest bezig houden met de grote beslissingen. Deze moest dan gewoon zijn team inlichten en vragen naar meningen en deze bundelen en op de vergadering brengen. \\
 
Ik, Sophie Marien, was de verantwoordelijke van team Zilver om naar de scheidsrechter commissie te gaan en ons team te vertegenwoordigden. Qua eigen inbreng heb ik het idee gegeven om de wip te detecteren door er een infraroodbal onder te plaatsen. Ik heb ook geprobeerd om via infraroodlichtjes op de robots het detectie probleem om te lossen. Dit ging uiteindelijk niet omdat de infraroodlichtjes niet straf genoeg waren. Ze werden wel gedetecteerd door de robot maar de afstand was niet groot genoeg om een andere robot op tijd te detecteren. \\
Voor de rest heb ik veel verslagen niet goed gekeurd wegens onnauwkeurigheden en soms omdat ik ook niet akkoord was met een beslissing. \\
