...
Om naar de plek van de andere robot te gaan wordt gebruik gemaakt van het kortste pad algoritme.
...
Het computerproject bevat een \textit{PlayerHandler} en een \textit{SpectatorHandler}, om respectievelijk in de \textit{AbstractPilot} en de \textit{DummyPilot} met informatie om te gaan. Een onderscheid is nodig omdat \textit{DummyPilots} niet aangestuurd kunnen worden.\\
