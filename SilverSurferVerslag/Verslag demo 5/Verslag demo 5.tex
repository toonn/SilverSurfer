...
\label{ssec:fysb}
Een infraroodsensor werd gemonteerd bovenop de robot. Wanneer een infraroodbal onder de wip geplaatst wordt, kan de robot bepalen of de wip naar beneden staat. In dat geval wordt het infrarood licht immers geblokt. Later kan de infraroodsensor eventueel gebruikt worden om robots te detecteren.\\
...
De schep werd samen met de lichtsensor gemonteerd op een hefboomsysteem. Wanneer het hefboomsysteem de wip raakt, kantelt het omhoog. Zo kan de robot vlot de wip op.
...
Bij de start van het tweede semester werd besloten een extra optimalisatie (F) toe te voegen. Deze geeft prioriteit aan het vinden van het voorwerp. Een voorwerp kan zich enkel bevinden op een `dead-end', voorafgegaan door een `straight' met een barcode. Deze barcode identificeert het voorwerp. Wanneer de robot een mogelijke voorwerplocatie vindt, controleert hij zo snel mogelijk of er werkelijk een voorwerp ligt en om welk voorwerp het gaat. \\

\begin{table}[!hb]
\begin{center}
    \begin{tabular}{ | c | c | c | c | } 
    \multicolumn{4}{|c|}{Robot beginplaats 00}
 \\   
     jj & cm afgelegd & \degree gedraaid & cm afgelegd\\ \hline \hline
    A & 2160 & 10620 & 1080 \\ \hline
    B & 1920 & 10800 & 1160 \\ \hline
    C & 2000 & 9090 & 1080 \\ \hline
    D & 2000 & 6570 & 1080\\ \hline
    8820 & 1880 & 6570 & 1080\\
    \end{tabular}
...
Een eerste reeks testen doet vermoeden dat het algoritme niet altijd effici"enter is met deze optimalisatie. Het is immers moeilijk het kortste pad naar de voorwerplocatie te bepalen omdat deze tegels vaak nog niet verkend zijn. Hierdoor maakt de robot veel omwegen. %(een duidelijk voorbeeld hiervan is doolhof 2 : ....) TODO
Deze resultaten verplichten ons na te denken over een alternatieve manier om deze optimalisatie te bereiken. Daarom wordt deze optimalisatie voorlopig niet toegevoegd aan het algoritme. \\
