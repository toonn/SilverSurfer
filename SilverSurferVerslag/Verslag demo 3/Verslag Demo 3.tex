...
% == calibratie == %
\subsection{Calibratie van de motoren} % 3 ?
\label{ssec:calibM}
...
\subsubsection{E\'en cm vooruit bewegen: bepalen van x} % 3 ?
\label{ssec:calibMx}
...
\label{ssec:calibLS}
De lichtsensor meet verschillende waarden onder verschillende omstandigheden
