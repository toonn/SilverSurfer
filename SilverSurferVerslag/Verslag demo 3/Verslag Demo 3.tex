...
\item \textit{\ref{ssec:calibUS} Calibratie van de ultrasone sensor:} meetresultaten toegevoegd.
\item \textit{\ref{ssec:algoVeelH} Het vinden van het korste pad:} nieuwe sectie.
\end{itemize}
