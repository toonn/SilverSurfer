...
Het kortste pad algoritme implementeert \textit{A*} \cite{A*}. Het maakt gebruik van een graaf die opgesteld wordt tijdens het verkennen van het doolhof. Als heuristiek wordt de Manhattanafstand \cite{manhattan} ge\"implementeerd en als kost de totale afgelegde afstand. Figuur \ref{fig:kortstepad} toont een uitvoering van het algoritme.
...
\begin{figure}
        ...
        \begin{subfigure}[hb]{0.75\textwidth}
                ...
                \caption{grafieken}
        \end{subfigure}
 \caption{Grafische weergave van de sensorwaarden.}
