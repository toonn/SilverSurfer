...
public class MessageCenter {
	 ...
	 * @param exchange		: The exchange you're sending to.
	...
	public void sendMessage(String exchange, String routingKey, String message){
        ...
        try {
			...
			System.out.println("MessageSender: There was a problem sending a message.");
			e.printStackTrace();
		}
	...
	/**
	 * Subscribe to a specified queue in the exchange that's in the Config class.
	 * Needs to be completed
	 * @param monitor_key: The queue you want to monitor.
	 */
	public void subscribeTo(String monitor_key){
		
		//TODO: aanvragende Pilot meegeven?
		SubscribeMonitor sm = new SubscribeMonitor(monitor_key, getChannel(), getConn());
		sm.start();
	...
	public static void main(String[] args) {
		...
		SubscribeMonitor sm = new SubscribeMonitor("race.*", ms.getChannel(), ms.getConn());
		sm.start();
