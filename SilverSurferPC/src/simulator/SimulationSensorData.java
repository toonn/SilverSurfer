...
public class SimulationSensorData {
    ...
    /**
     * Mean value of the light sensor, when standing a white line under given
     * circumstances.
     */
    ...
    /**
     * Standard Deviation of the light sensor, when standing on a panel
     * containing a barcode under given circumstances. The color should be 0
     * when standing on a black part, 1 when standing on a white part or
     * something else when standing next to the panel.
     */
    ...
    /**
     * Standard Deviation of the light sensor, when standing on an empty panel
    ...
    /**
     * Standard Deviation of the light sensor, when standing a white line under
     * given circumstances.
     */
    ...
    public static void setDriving(final boolean isDriving) {
