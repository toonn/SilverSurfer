...
public class Barcode extends TileContent {
     ...
     */
    public Barcode(int value, Orientation direction, Tile tile) {
        super(tile);
        setValue(value);
     ...
     */
    public Rectangle2D[] createVisualBarCode(double sizeTile) {
