...
public class BarcodeCommand {
	...
	//First ints of arrays are for robot 0 (above: he will belong to team 0, below: he will belong to team 1)
    ...
    private static int calcInv(int value) {
		...
		if(newValue == oldValue)
			...
			number[5] = 1;
		int newNumber = 1*number[0] + 2*number[1] + 4*number[2] + 8*number[3] + 16*number[4] + 32*number[5];
		return newNumber;
	}
}
/*
Alle combinaties (getal en inverse getal) - NIET VERWIJDEREN!
0  0
1  32
2  16
3  48
